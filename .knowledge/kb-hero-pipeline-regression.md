...
|---|---|---|---|---|
| Movement（无 collision） | 1256.4 | 0.8 | 37691 | 稳定 |
| Attack（含 collision） | 805.4 | 1.2 | 24163 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1005 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥644 rounds/s（baseline 的 80%）
