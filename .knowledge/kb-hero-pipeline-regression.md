...
|---|---|---|---|---|
| Movement（无 collision） | 1489.0 | 0.7 | 44670 | 稳定 |
| Attack（含 collision） | 841.3 | 1.2 | 25238 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1191 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥673 rounds/s（baseline 的 80%）
