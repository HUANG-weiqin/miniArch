...
|---|---|---|---|---|
| Movement（无 collision） | 883.1 | 1.1 | 26493 | 稳定 |
| Attack（含 collision） | 217.9 | 4.6 | 6536 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥706 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥174 rounds/s（baseline 的 80%）
