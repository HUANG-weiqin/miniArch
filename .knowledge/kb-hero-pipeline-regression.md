...
|---|---|---|---|---|
| Movement（无 collision） | 569.5 | 1.8 | 17084 | 稳定 |
| Attack（含 collision） | 47.6 | 21.0 | 1427 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥455 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥38 rounds/s（baseline 的 80%）
