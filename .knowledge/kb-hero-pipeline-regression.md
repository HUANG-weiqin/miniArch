...
|---|---|---|---|---|
| Movement（无 collision） | 1305.8 | 0.8 | 39173 | 稳定 |
| Attack（含 collision） | 817.5 | 1.2 | 24526 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1044 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥654 rounds/s（baseline 的 80%）
