...
|---|---|---|---|---|
| Movement（无 collision） | 698.0 | 1.4 | 20940 | 稳定 |
| Attack（含 collision） | 181.6 | 5.5 | 5448 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥558 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥145 rounds/s（baseline 的 80%）
