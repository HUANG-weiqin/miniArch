...
|---|---|---|---|---|
| Movement（无 collision） | 964.4 | 1.0 | 28933 | 稳定 |
| Attack（含 collision） | 652.3 | 1.5 | 19570 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥771 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥521 rounds/s（baseline 的 80%）
