...
|---|---|---|---|---|
| Movement（无 collision） | 918.9 | 1.1 | 27568 | 稳定 |
| Attack（含 collision） | 220.2 | 4.5 | 6607 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥735 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥176 rounds/s（baseline 的 80%）
