...
|---|---|---|---|---|
| Movement（无 collision） | 1774.9 | 0.6 | 53246 | 稳定 |
| Attack（含 collision） | 1084.4 | 0.9 | 32531 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1419 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥867 rounds/s（baseline 的 80%）
