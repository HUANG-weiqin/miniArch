...
|---|---|---|---|---|
| Movement（无 collision） | 1759.6 | 0.6 | 52789 | 稳定 |
| Attack（含 collision） | 1068.3 | 0.9 | 32048 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1407 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥854 rounds/s（baseline 的 80%）
