...
|---|---|---|---|---|
| Movement（无 collision） | 1232.7 | 0.8 | 36981 | 稳定 |
| Attack（含 collision） | 737.1 | 1.4 | 22114 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥986 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥589 rounds/s（baseline 的 80%）
