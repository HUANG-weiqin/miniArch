...
|---|---|---|---|---|
| Movement（无 collision） | 1274.3 | 0.8 | 38228 | 稳定 |
| Attack（含 collision） | 819.1 | 1.2 | 24574 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1019 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥655 rounds/s（baseline 的 80%）
