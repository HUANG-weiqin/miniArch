...
|---|---|---|---|---|
| Movement（无 collision） | 614.7 | 1.6 | 18442 | 稳定 |
| Attack（含 collision） | 63.3 | 15.8 | 1899 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥491 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥50 rounds/s（baseline 的 80%）
