...
|---|---|---|---|---|
| Movement（无 collision） | 1294.2 | 0.8 | 38826 | 稳定 |
| Attack（含 collision） | 817.5 | 1.2 | 24524 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1035 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥653 rounds/s（baseline 的 80%）
