...
|---|---|---|---|---|
| Movement（无 collision） | 1289.7 | 0.8 | 38692 | 稳定 |
| Attack（含 collision） | 802.6 | 1.2 | 24077 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1031 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥642 rounds/s（baseline 的 80%）
