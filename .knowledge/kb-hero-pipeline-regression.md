...
|---|---|---|---|---|
| Movement（无 collision） | 788.2 | 1.3 | 23646 | 稳定 |
| Attack（含 collision） | 467.5 | 2.1 | 14024 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥630 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥373 rounds/s（baseline 的 80%）
