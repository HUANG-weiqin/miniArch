...
|---|---|---|---|---|
| Movement（无 collision） | 1701.1 | 0.6 | 51032 | 稳定 |
| Attack（含 collision） | 1048.2 | 1.0 | 31447 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1360 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥838 rounds/s（baseline 的 80%）
