...
|---|---|---|---|---|
| Movement（无 collision） | 1291.1 | 0.8 | 38734 | 稳定 |
| Attack（含 collision） | 783.4 | 1.3 | 23502 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1032 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥626 rounds/s（baseline 的 80%）
