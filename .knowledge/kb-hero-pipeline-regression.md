...
|---|---|---|---|---|
| Movement（无 collision） | 1263.3 | 0.8 | 37898 | 稳定 |
| Attack（含 collision） | 813.8 | 1.2 | 24413 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1010 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥651 rounds/s（baseline 的 80%）
