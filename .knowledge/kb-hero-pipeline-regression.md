...
|---|---|---|---|---|
| Movement（无 collision） | 667.4 | 1.5 | 20021 | 稳定 |
| Attack（含 collision） | 185.4 | 5.4 | 5563 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥533 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥148 rounds/s（baseline 的 80%）
