...
|---|---|---|---|---|
| Movement（无 collision） | 1615.7 | 0.6 | 48472 | 稳定 |
| Attack（含 collision） | 993.7 | 1.0 | 29810 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1292 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥794 rounds/s（baseline 的 80%）
