...
|---|---|---|---|---|
| Movement（无 collision） | 1634.5 | 0.6 | 49035 | 稳定 |
| Attack（含 collision） | 989.6 | 1.0 | 29687 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1307 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥791 rounds/s（baseline 的 80%）
