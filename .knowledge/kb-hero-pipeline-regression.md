...
|---|---|---|---|---|
| Movement（无 collision） | 638.7 | 1.6 | 19160 | 稳定 |
| Attack（含 collision） | 60.8 | 16.4 | 1825 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥510 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥48 rounds/s（baseline 的 80%）
