...
|---|---|---|---|---|
| Movement（无 collision） | 1012.4 | 1.0 | 30373 | 稳定 |
| Attack（含 collision） | 233.8 | 4.3 | 7014 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥809 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥187 rounds/s（baseline 的 80%）
