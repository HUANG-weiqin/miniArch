...
|---|---|---|---|---|
| Movement（无 collision） | 674.5 | 1.5 | 20236 | 稳定 |
| Attack（含 collision） | 211.7 | 4.7 | 6350 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥539 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥169 rounds/s（baseline 的 80%）
