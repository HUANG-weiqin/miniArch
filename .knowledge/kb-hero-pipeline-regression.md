...
|---|---|---|---|---|
| Movement（无 collision） | 1681.3 | 0.6 | 50440 | 稳定 |
| Attack（含 collision） | 1030.4 | 1.0 | 30913 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1345 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥824 rounds/s（baseline 的 80%）
