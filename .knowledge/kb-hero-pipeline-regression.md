...
|---|---|---|---|---|
| Movement（无 collision） | 1222.6 | 0.8 | 36677 | 稳定 |
| Attack（含 collision） | 807.9 | 1.2 | 24237 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥978 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥646 rounds/s（baseline 的 80%）
