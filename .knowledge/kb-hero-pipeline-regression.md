...
|---|---|---|---|---|
| Movement（无 collision） | 1087.6 | 0.9 | 32629 | 稳定 |
| Attack（含 collision） | 631.1 | 1.6 | 18933 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥870 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥504 rounds/s（baseline 的 80%）
