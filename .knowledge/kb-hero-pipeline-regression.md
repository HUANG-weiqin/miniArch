...
|---|---|---|---|---|
| Movement（无 collision） | 890.5 | 1.1 | 26716 | 稳定 |
| Attack（含 collision） | 221.5 | 4.5 | 6645 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥712 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥177 rounds/s（baseline 的 80%）
