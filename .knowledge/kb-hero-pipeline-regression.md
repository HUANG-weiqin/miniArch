...
|---|---|---|---|---|
| Movement（无 collision） | 692.6 | 1.4 | 20778 | 稳定 |
| Attack（含 collision） | 191.4 | 5.2 | 5741 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥554 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥153 rounds/s（baseline 的 80%）
