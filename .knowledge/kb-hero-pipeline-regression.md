...
|---|---|---|---|---|
| Movement（无 collision） | 894.6 | 1.1 | 26839 | 稳定 |
| Attack（含 collision） | 593.2 | 1.7 | 17797 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥715 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥474 rounds/s（baseline 的 80%）
