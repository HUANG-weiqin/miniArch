...
|---|---|---|---|---|
| Movement（无 collision） | 1755.6 | 0.6 | 52669 | 稳定 |
| Attack（含 collision） | 1082.6 | 0.9 | 32478 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1404 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥866 rounds/s（baseline 的 80%）
