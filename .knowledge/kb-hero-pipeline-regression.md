...
|---|---|---|---|---|
| Movement（无 collision） | 1068.4 | 0.9 | 32051 | 稳定 |
| Attack（含 collision） | 646.3 | 1.5 | 19389 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥854 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥517 rounds/s（baseline 的 80%）
