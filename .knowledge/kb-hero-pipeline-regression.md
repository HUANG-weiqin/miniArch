...
|---|---|---|---|---|
| Movement（无 collision） | 1686.4 | 0.6 | 50591 | 稳定 |
| Attack（含 collision） | 1011.1 | 1.0 | 30332 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1349 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥808 rounds/s（baseline 的 80%）
