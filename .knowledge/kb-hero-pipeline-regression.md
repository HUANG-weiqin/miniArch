...
|---|---|---|---|---|
| Movement（无 collision） | 685.0 | 1.5 | 20552 | 稳定 |
| Attack（含 collision） | 177.6 | 5.6 | 5327 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥548 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥142 rounds/s（baseline 的 80%）
