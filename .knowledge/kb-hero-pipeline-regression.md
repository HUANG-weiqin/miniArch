...
|---|---|---|---|---|
| Movement（无 collision） | 1084.4 | 0.9 | 32533 | 稳定 |
| Attack（含 collision） | 634.1 | 1.6 | 19025 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥867 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥507 rounds/s（baseline 的 80%）
