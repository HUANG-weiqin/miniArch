...
|---|---|---|---|---|
| Movement（无 collision） | 1721.2 | 0.6 | 51636 | 稳定 |
| Attack（含 collision） | 1046.1 | 1.0 | 31384 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1376 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥836 rounds/s（baseline 的 80%）
