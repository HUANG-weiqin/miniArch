...
|---|---|---|---|---|
| Movement（无 collision） | 936.6 | 1.1 | 28098 | 稳定 |
| Attack（含 collision） | 228.7 | 4.4 | 6861 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥749 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥182 rounds/s（baseline 的 80%）
