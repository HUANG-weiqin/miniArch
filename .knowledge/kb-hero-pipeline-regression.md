...
|---|---|---|---|---|
| Movement（无 collision） | 651.0 | 1.5 | 19530 | 稳定 |
| Attack（含 collision） | 63.9 | 15.6 | 1918 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥520 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥51 rounds/s（baseline 的 80%）
