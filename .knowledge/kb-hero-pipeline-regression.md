...
|---|---|---|---|---|
| Movement（无 collision） | 1058.3 | 0.9 | 31749 | 稳定 |
| Attack（含 collision） | 636.4 | 1.6 | 19091 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥846 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥509 rounds/s（baseline 的 80%）
