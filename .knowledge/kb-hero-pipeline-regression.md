...
|---|---|---|---|---|
| Movement（无 collision） | 1083.3 | 0.9 | 32498 | 稳定 |
| Attack（含 collision） | 250.7 | 4.0 | 7521 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥866 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥200 rounds/s（baseline 的 80%）
