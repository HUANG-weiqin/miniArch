...
|---|---|---|---|---|
| Movement（无 collision） | 499.7 | 2.0 | 14991 | 稳定 |
| Attack（含 collision） | 54.3 | 18.4 | 1631 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥399 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥43 rounds/s（baseline 的 80%）
