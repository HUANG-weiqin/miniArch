...
|---|---|---|---|---|
| Movement（无 collision） | 859.2 | 1.2 | 25777 | 稳定 |
| Attack（含 collision） | 194.5 | 5.1 | 5836 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥687 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥155 rounds/s（baseline 的 80%）
