...
|---|---|---|---|---|
| Movement（无 collision） | 917.2 | 1.1 | 27517 | 稳定 |
| Attack（含 collision） | 225.1 | 4.4 | 6752 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥733 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥180 rounds/s（baseline 的 80%）
