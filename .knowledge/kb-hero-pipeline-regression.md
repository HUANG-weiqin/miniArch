...
|---|---|---|---|---|
| Movement（无 collision） | 1678.2 | 0.6 | 50347 | 稳定 |
| Attack（含 collision） | 1004.9 | 1.0 | 30148 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1342 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥803 rounds/s（baseline 的 80%）
