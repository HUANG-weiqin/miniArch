...
|---|---|---|---|---|
| Movement（无 collision） | 1102.1 | 0.9 | 33064 | 稳定 |
| Attack（含 collision） | 247.4 | 4.0 | 7423 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥881 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥197 rounds/s（baseline 的 80%）
