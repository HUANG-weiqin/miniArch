...
|---|---|---|---|---|
| Movement（无 collision） | 1341.0 | 0.7 | 40231 | 稳定 |
| Attack（含 collision） | 800.1 | 1.2 | 24003 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1072 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥640 rounds/s（baseline 的 80%）
