...
|---|---|---|---|---|
| Movement（无 collision） | 1713.0 | 0.6 | 51389 | 稳定 |
| Attack（含 collision） | 1056.6 | 0.9 | 31700 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1370 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥845 rounds/s（baseline 的 80%）
