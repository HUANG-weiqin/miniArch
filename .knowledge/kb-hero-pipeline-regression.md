...
|---|---|---|---|---|
| Movement（无 collision） | 1230.9 | 0.8 | 36926 | 稳定 |
| Attack（含 collision） | 769.7 | 1.3 | 23092 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥984 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥615 rounds/s（baseline 的 80%）
