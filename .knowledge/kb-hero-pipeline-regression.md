...
|---|---|---|---|---|
| Movement（无 collision） | 628.1 | 1.6 | 18844 | 稳定 |
| Attack（含 collision） | 196.1 | 5.1 | 5883 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥502 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥156 rounds/s（baseline 的 80%）
