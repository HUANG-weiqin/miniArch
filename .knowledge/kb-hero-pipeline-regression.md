...
|---|---|---|---|---|
| Movement（无 collision） | 979.5 | 1.0 | 29386 | 稳定 |
| Attack（含 collision） | 230.4 | 4.3 | 6913 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥783 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥184 rounds/s（baseline 的 80%）
