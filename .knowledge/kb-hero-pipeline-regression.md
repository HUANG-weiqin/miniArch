...
|---|---|---|---|---|
| Movement（无 collision） | 1287.2 | 0.8 | 38615 | 稳定 |
| Attack（含 collision） | 811.3 | 1.2 | 24340 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1029 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥649 rounds/s（baseline 的 80%）
