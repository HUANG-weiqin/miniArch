...
|---|---|---|---|---|
| Movement（无 collision） | 1708.0 | 0.6 | 51240 | 稳定 |
| Attack（含 collision） | 1039.1 | 1.0 | 31173 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1366 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥831 rounds/s（baseline 的 80%）
