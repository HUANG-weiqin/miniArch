...
|---|---|---|---|---|
| Movement（无 collision） | 898.8 | 1.1 | 26963 | 稳定 |
| Attack（含 collision） | 226.7 | 4.4 | 6800 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥719 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥181 rounds/s（baseline 的 80%）
