...
|---|---|---|---|---|
| Movement（无 collision） | 1730.6 | 0.6 | 51917 | 稳定 |
| Attack（含 collision） | 1053.6 | 0.9 | 31609 | 稳定 |

### 回归阈值

- Movement 吞吐量：≥1384 rounds/s（baseline 的 80%）
- Attack 吞吐量：≥842 rounds/s（baseline 的 80%）
