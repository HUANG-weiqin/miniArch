...
public sealed class CommandBufferCloneTests
{
    ...
    public void Clone_creates_deferred_entity_with_components()
    {
        ...
        var clone = buffer.CloneImmediate(source);
    ...
    public void Clone_throws_on_dead_entity()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => buffer.CloneImmediate(entity));
    }
    ...
    public void Clone_with_other_commands_in_same_buffer()
    {
        ...
        var cloned = buffer.CloneImmediate(source);
        var created = buffer.CreateImmediate();
    ...
    public void Multiple_clones_from_same_source()
    {
        ...
        var clone1 = buffer.CloneImmediate(source);
        var clone2 = buffer.CloneImmediate(source);
        buffer.Submit();
    ...
    public void Deep_clone_copies_children_after_submit()
    {
        ...
        var clone = buffer.CloneImmediate(parent);
        buffer.Submit();
    ...
    public void Deep_clone_preserves_hierarchy_after_submit()
    {
        ...
        var clone = buffer.CloneImmediate(root);
        buffer.Submit();
